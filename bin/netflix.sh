...
xrandr --output HDMI-1 --mode 1920x1080 --pos 0x0 --rotate normal --output LVDS-1 --primary --mode 1366x768 --pos 1920x312 --rotate normal --output VIRTUAL1 --off --output DP1 --off --output VGA1 --off
...
# disables hdmi
xrandr --output HDMI-1 --off --output LVDS-1 --primary --mode 1366x768 --pos 0x0 --rotate normal --output VIRTUAL1 --off --output DP1 --off --output VGA1 --off
