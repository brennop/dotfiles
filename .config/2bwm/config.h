...
///---Modifiers---///
#define MOD                                                                    \
  XCB_MOD_MASK_4 /* Super/Windows key  or check xmodmap(1) with -pm  defined   \
                    in /usr/include/xcb/xproto.h */
///--Speed---///
/* Move this many pixels when moving or resizing with keyboard unless the window
 *has hints saying otherwise. 0)move step slow   1)move step fast 2)mouse slow
 *3)mouse fast     */
 ...
 *6)emptycol         */
static const char *colors[] = {"#ebebeb", "#ebebeb", "#ee483e", "#ee483e",
                               "#ee483e", "#262b31", "#000000"};
...
// static const char *sloppy_switch_cmd[] = { "notify-send", "toggle sloppy",
// NULL };
