...
static const uint16_t movements[] = {16,32,15,400};
...
static const char *screenshot[] = { "flemeshot", "gui", NULL};
///--Custom foo---///
...
static key keys[] = {
    ...
    {  MOD ,              XK_q,          start,             {.com = browser}},
    {  MOD ,              XK_Print,          start,             {.com = screenshot}},
