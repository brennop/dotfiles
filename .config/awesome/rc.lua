...
globalkeys = gears.table.join(
    awful.key({ modkey,           }, "n",      hotkeys_popup.show_help,
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = 2 or beautiful.border_width,
                     border_color = "#262b31" or beautiful.border_normal,
...
awful.spawn.with_shell("~/bin/start.sh")
